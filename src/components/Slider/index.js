  ...
  render() {
    return (
      <div
        ...
        className={cx("animatable", {
          ["to"]: [Slider.TO_LEFT, Slider.TO_RIGHT, Slider.TO_DOWN, Slider.TO_UP].includes(
            this.state.position
          ),
          ["from"]: [Slider.FROM_LEFT, Slider.FROM_RIGHT, Slider.FROM_UP, Slider.FROM_DOWN].includes(
            this.state.position
          ),
          ...
          ["up"]: [Slider.TO_UP, Slider.FROM_UP].includes(
            this.state.position
          ),
          ["down"]: [Slider.TO_DOWN, Slider.FROM_DOWN].includes(
            this.state.position
          ),
...
Slider.TO_DOWN = "TO_DOWN";
Slider.TO_UP = "TO_UP";
Slider.FROM_LEFT = "FROM_LEFT";
Slider.FROM_RIGHT = "FROM_RIGHT";
Slider.FROM_DOWN = "FROM_DOWN";
Slider.FROM_UP = "FROM_UP";
