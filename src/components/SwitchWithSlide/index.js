...
class SlideOut extends React.Component {
  ...
  swapChildren = (prevProps, prevState) => {
    ...
    if (uniqId === '/blog') position = Slider.FROM_DOWN
    if (uniqId === '/') {
      ...
      else if (prevUniqId === '/blog') position = Slider.FROM_UP
    }
